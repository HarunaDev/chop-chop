...
function SpecialMenu() {
    return (
        <section id="special-section" className="h-auto py-16 px-16 bg-[#F8E44D]">
            ...
            <MenuCard detail="1pc Big Burger & Smoothie" img={BurgerSmoothie} style="flex-row-reverse" margin="mr-auto" text="text-end" marginL="ml-auto" />
